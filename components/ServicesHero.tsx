      ...
      <div className="container-custom">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            <span className="text-primary">Reliable Mechanical Repairs</span>
            <br />
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-3xl mx-auto">
            Experienced mechanic offering honest service and quality workmanship. Reliable automotive care for all makes and models in St George.
          </p>
