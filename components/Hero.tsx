      ...
      <div className="container-custom text-center">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight px-4">
            <span className="text-primary">Modern hairdressing for the St George community</span>
            <br />
            <span className="text-white">Cuts, colours & styling inside a warm, boutique hair parlour</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto px-4 leading-relaxed">
            Experienced stylists offering personalised service and modern techniques in St George, Queensland.
          </p>
